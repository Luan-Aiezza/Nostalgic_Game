...
class GameScene: SKScene {
    ...
    override func sceneDidLoad() {
        ...
        let tutorialEntity0 = TutorialEntity(texture: SKTexture(imageNamed: "tutorial0"))
        tutorialEntity0.component(ofType: GKSKNodeComponent.self)!.node.position = CGPoint(x: -200, y: 380)
        entityManager?.add(entity: tutorialEntity0)
        let tutorialEntity1 = TutorialEntity(texture: SKTexture(imageNamed: "tutorial1"))
        tutorialEntity1.component(ofType: GKSKNodeComponent.self)!.node.position = CGPoint(x: -80, y: 380)
        entityManager?.add(entity: tutorialEntity1)
        let tutorialEntity2 = TutorialEntity(texture: SKTexture(imageNamed: "tutorial2"))
        tutorialEntity2.component(ofType: GKSKNodeComponent.self)!.node.position = CGPoint(x: 80, y: 380)
        entityManager?.add(entity: tutorialEntity2)
