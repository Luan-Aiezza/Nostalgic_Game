...
class GameScene: SKScene {
    ...
    public func captureInput(touches: Set<UITouch>) {
        ...
        func ghostAdd(){
            ...
            guard let path1 = ghost1.moveComponent?.moveGhost(points:[CGPoint(x: 700, y: -225), CGPoint(x: 700, y: -90), CGPoint(x: 180, y: -90), CGPoint(x: 180, y: -225)], duration: [2.5, 1.5, 2.5, 1.5], direction: .right) else {return}
