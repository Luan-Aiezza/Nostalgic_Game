...
class GameScene: SKScene {
    ...
    public func captureInput(touches: Set<UITouch>, isTouching: Bool) {
        ...
        func ghostAdd(){
            ...
            guard let path1 = ghost1.moveComponent?.moveGhost(points:[CGPoint(x: 700, y: -225), CGPoint(x: 700, y: -90), CGPoint(x: 180, y: -90), CGPoint(x: 180, y: -225)], duration: [2, 1, 2, 1], direction: .left) else {return}
            ...
            guard let path2 = ghost2.moveComponent?.moveGhost2WayPoints(points:[CGPoint(x: -930, y: -90), CGPoint(x: -280, y: -90)], duration: [2.5, 2.5], direction: .left) else {return}
            ...
            guard let path3 = ghost3.moveComponent?.moveGhost2WayPoints(points:[CGPoint(x: -840, y: -360), CGPoint(x: 500, y: -380)], duration: [4, 4], direction: .left) else {return}
            ...
            guard let path4 = ghost4.moveComponent?.moveGhost2WayPoints(points:[CGPoint(x: -560, y: -1230), CGPoint(x: -940, y: -1230)], duration: [2.5, 2.5], direction: .right) else {return}
            ...
            guard let path5 = ghost5.moveComponent?.moveGhostMultipleWayPoints(points:[CGPoint(x: -920, y: -950), CGPoint(x: -790, y: -950), CGPoint(x:  -790, y: -830), CGPoint(x: -470, y: -830), CGPoint(x:  -470, y: -950), CGPoint(x: -670, y: -950), CGPoint(x: -670, y: -1080),  CGPoint(x: -920, y: -1080)], duration: [1, 2, 1.5, 2.5, 1, 2, 1, 2], direction: .left) else {return}
            ...
            guard let path6 = ghost6.moveComponent?.moveGhostMultipleWayPoints(points: [CGPoint(x: 485, y: -1080), CGPoint(x: 485, y: -955), CGPoint(x: 765, y: -955), CGPoint(x: 765, y: -780), CGPoint(x: 925, y: -780), CGPoint(x: 925, y: -1230), CGPoint(x: 640, y: -1230), CGPoint(x: 640, y: -955), CGPoint(x: 485, y: -955), CGPoint(x: 485, y: -1080), CGPoint(x: 80, y: -1080)], duration: [2, 1, 1.5, 1, 1, 3, 2.5, 2.5, 1, 1, 2], direction: .left) else {return}
